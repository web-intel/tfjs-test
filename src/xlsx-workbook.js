var xlsx = require('xlsx'), path = require('path');
...
function Workbook(sheets) {
  Object.defineProperty(
    this, 'sheets', { 'enumerable': false, 'writable': true, 'value': [] });
...
function addSheetProperty(wb, S, i) {
  Object.defineProperty(
    wb, S, { 'enumerable': true, 'writable': false, 'value': wb.sheets[i] });
}
...
Workbook.prototype.save =
  function (name) {
    ...
    // "xlsx" or "xlsm"
    xlsx.writeFile(
      wb, filename, { bookType: 'xlsx', bookSST: true, type: 'binary' });
  }
...
function Worksheet(name, rows) {
  ...
  Object.defineProperty(
    this, 'name', { 'enumerable': false, 'writable': true, 'value': name });

  Object.defineProperty(
    this, 'data', { 'enumerable': false, 'writable': true, 'value': [] });

  Object.defineProperty(
    this, 'length', { 'enumerable': false, 'writable': true, 'value': 0 });
